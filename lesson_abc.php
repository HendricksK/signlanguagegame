...
//object creation
	...
	$alphabet_game->game_type = "lesson_game_alphabet";
		...
		<div class="site-container">
			<div class="panel panel-default">
				...
				$counter = 0;
					...
					$result = mysqli_query($conn, "SELECT * FROM lesson_game_alphabet");
					...
					//echo $lesson;
							...
							echo '
							<a class="thumbnail strip animated" data-lesson="'.$lesson.'" href="./learn_abc.php?q='.$lesson.'&g=lesson_game_alphabet" id="'.$lesson.'">
					 			'.$lesson_name.'
						   	</a>
						   	';
						   	$counter++;
