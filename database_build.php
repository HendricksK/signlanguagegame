...
$conn = new mysqli($servername, $username, $password, "sign_game");
		...
		<div class="site-container">
			<div class="panel panel-default">
				...
				$letterCounter = 0;
					...
					$result = mysqli_query($conn, "SELECT * FROM lesson_game_alphabet WHERE lesson_id = 1");
					...
					// do not need to create a new connection, just another query :) 
						...
						while($counter < 16){
							echo '
							<a class="thumbnail strip animated" data-letter="'.$letters[$counter].'" href="#" id="'.$number.'">
					 			<img src="./assets/images/@milo.jpg">
							...
							<a class="thumbnail strip inverted" href="#" id="'.$number.'">
					 			<img src="./assets/images/6_2_s_by_wlop-d8fblew.jpg">
						    		<p class="signed-word"> hello there my name is hendrix</p>
						   	</a>';
						   	$number++;
						   	$counter++;
